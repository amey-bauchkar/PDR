...
const CATALOG: CatalogItem[] = [
  // Card 1 — PDR Cat 6 24/48-Port Patch Panel
  {
    ...
    image: '/images/live/cat-6-patch-panel.png',
  ...
  // Card 2 — PDR Fiber Distribution Box (FDB24B)
  {
    ...
    image: '/images/live/fiber-distribution-box-fdb.png',
  ...
  // Card 3 — PDR Home Termination Box (HTB)
  {
    ...
    image: '/images/live/home-termination-box-htb.png',
  ...
  // Card 4 — PDR Horizontal Splice Closure (HTSC-TL16)
  {
    ...
    image: '/images/live/fiber-optic-splitter-closure-gjs-2016.png',
  ...
  // Card 5 — PDR Heat Shrink Splice Closure
  {
    ...
    image: '/images/live/heat-shrink-splice-closure.png',
  ...
  // Card 6 — PDR Optical Fiber Wall Mount Enclosure
  {
    ...
    image: '/images/live/optical-fiber-wall-mount-enclosure.png',
  ...
  // Card 7 — PDR Rack Mount Fiber Management System (FMS)
  {
    ...
    image: '/images/live/rack-mount-fiber-management-system.png',
